<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEmpleado.master" AutoEventWireup="true" CodeFile="ABMLocalComercial.aspx.cs" Inherits="ABMLocalComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <span class="style9">ABM Local Comercial</span><br />
...
&nbsp;<asp:Button ID="btnBuscarZona" runat="server" Enabled="False" onclick="btnBuscarZona_Click" 
            ...
            <tr>
                <td class="style3">
                    Direccion:</td>
                <td class="style4">
                    <asp:TextBox ID="txtDireccion" runat="server" Enabled="False" Width="220px"></asp:TextBox>
                </td>
                <td class="style5">
                </td>
            </tr>
