<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEmpleado.master" AutoEventWireup="true" CodeFile="ABMApartamento.aspx.cs" Inherits="ABMApartamento" %>
...
&nbsp;<asp:Button ID="btnBuscarZona" runat="server" Enabled="False" onclick="btnBuscarZona_Click" 
            ...
            <tr>
                <td class="style3">
                    Direccion:</td>
                <td class="style4">
                    <asp:TextBox ID="txtDireccion" runat="server" Enabled="False" Width="227px"></asp:TextBox>
                </td>
                <td class="style5">
                </td>
            </tr>
